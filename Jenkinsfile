pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://54.209.93.56:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/MaheshReddy1816/fullstackapp.git', branch: 'main'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://54.209.93.56:9090/springapp1"
            echo "✅ Frontend deployed: http://54.209.93.56:9090/frontapp1"
        }
        failure {
